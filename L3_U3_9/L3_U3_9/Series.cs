...
namespace L3_U3_9
{
    class Series : Video
    {
        ...
        public Series(string name, string startDate, string genre, string studio, string endDate, string actor1, string actor2, int episodes, string airing) : base(name, genre, studio, actor1, actor2)
        {
            StartDate = startDate;
            Episodes = episodes;
            EndDate = endDate;
